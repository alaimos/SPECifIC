...
@section('content')
    <section class="content content-boxed">
        <div class="push-10-t push-10">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="h4 font-w600 text-uppercase push-10">Authors</h3>
                    <div class="block">
                ...
                <div class="col-md-6">
                    <h3 class="h4 font-w600 text-uppercase push-10">Bugs Reporting</h3>
                    <div class="block">
                        <div class="block-content">
                            <div class="row items-push">
                                <div class="col-md-12">
                                    <p>
                                        ...
                                        project: <a href="https://github.com/alaimos/SPECifIC/issues">https://github.com/alaimos/SPECifIC/issues</a>.
                                    </p>
                                </div>
                            </div>
                        </div>
